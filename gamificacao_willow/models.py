...
class Turma(Base):
    ...
    ano = Column(String, nullable=True) # Alterado de Integer para String
...
class Matricula(Base):
    ...
    # CORRIGIDO AQUI: 'back_popates' -> 'back_populates'
...
class Aluno(Base):
    ...
    badges = Column(Text, default="[]") # Armazena como string JSON
